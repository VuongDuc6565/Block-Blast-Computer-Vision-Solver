...
def calculate(blocksDone):
    ...
    screenshot_util.capture_fullscreen("temp/screen.png")
    img = cv2.imread("temp/screen.png", 1)
    ...
    screenshot_util.capture_fullscreen("temp/screen2.png")
    # print("Screenshotting!!!")
    img = cv2.imread("temp/screen2.png", 1)
